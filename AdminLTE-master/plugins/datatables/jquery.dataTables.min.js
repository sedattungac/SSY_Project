...
sNext:"İleri",sPrevious:"Önceki"},sEmptyTable:"No data available in table",sInfo:"_START_. sayfasında gösterilen _END_ değer toplam: _TOTAL_ değer",sInfoEmpty:"Gösterilen 0 to 0 of 0 değerden",sInfoFiltered:"(_MAX_ değer arasından)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Ara:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aradığınız değer bulunamadı"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
